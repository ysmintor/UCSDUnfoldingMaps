...
public class EarthquakeCityMap extends PApplet {
	...
	private void sortAndPrint(int numToPrint) {
		List<EarthquakeMarker> sortMarker = new ArrayList<EarthquakeMarker>();
		for (Marker m : quakeMarkers) {
			sortMarker.add((EarthquakeMarker) m);
		}
		// sort the Markers
		Collections.sort(sortMarker);
		
		// print
		for (EarthquakeMarker i : sortMarker) {
			if (numToPrint > 0) {
